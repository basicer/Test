class Item extends Component
  ...
  equip: ->
    ...
    if @owner.isProgrammable
      ...
      programmableProperties = @programmableProperties.concat @moreProgrammableProperties
      for prop in programmableProperties when not (prop in @owner.programmableProperties)
        @owner.programmableProperties.push prop unless prop in @moreProgrammableProperties
