...
class Collects extends Component
  ...
  canCollect: (collectable) ->
    not @dead and @distanceSquared(collectable, false) < @collectRangeSquared + 25 and @distanceSquared(collectable, true) < @collectRangeSquared and not (collectable.isCarryable and collectable.parent)
