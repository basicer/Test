...
class Collides extends Component
  @className: "Collides"
  collides: true
  ...
  updateCollisionFilterBits: (filter, catName) ->
    ...
    cat = collisionSystem.allCategories[CollisionCategory.nameFor catName or @collisionCategory, superteamIndex]
  ...
  cancelCollisions: (becauseOfDeath=false) ->
    return unless @body
    ...
    catName = CollisionCategory.nameFor if becauseOfDeath then "dead" else "none"
