class ProximityTrigger extends Component
  ...
  chooseAction: ->
    ...
    for thang in @extantColliders when thang.collisionCategory isnt 'none' and thang.isMovable and thang isnt @ and @distanceSquared(thang) < @triggerRangeSquared and @shouldInteractWith(thang) and not @dud
