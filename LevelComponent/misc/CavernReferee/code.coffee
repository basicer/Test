...
class CavernReferee extends Component
  @className: 'CavernReferee'
  ...
  chooseAction: ->
    ...
    for heroID in ['Hero Placeholder', 'Hero Placeholder 1']
      ...
      @westRect ?= new Rectangle(50, 66, 44, 84)
      #@eastRect ?= new Rectangle(122, 66, 70, 126)
      @eastRect ?= new Rectangle(110, 66, 44, 84)
